...
DocumentReference? get currentUserReference =>
    loggedIn ? PacientesRecord.collection.doc(currentUser!.uid) : null;

PacientesRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : PacientesRecord.getDocument(PacientesRecord.collection.doc(uid))
              .handleError((_) {}),
    )
